...
\newpage
# Sammendrag
Denne rapporten handler om et delvis misslykket forsøk på å bygge en drone.
Vi reflekterer litt over hvordan man skal bygge en bra drone, hva som gikk galt
...
På en drone er det best om massepunktet er lavt.
Det vil si det tyngste punktet på dronen.
Den forenklede forklaringen er at det er punktet på dronen som tyngdekraften virker på.
Hvis Man tenker seg at man skal hoppe ut av et fly mens man holder en stor stein over hodet,
vil det være mye vanskeligere å lande med beina først enn om man holdt steinen med beina.
...
![Mats på en god dag](bilder/Mats på en god dag.jpg){width="50%"}

Mottakeren har 7 kanaler. Derfor kan to kanaler gå til 2 av/på brytere.
4 kanaler kan gå til to joysticker og en kanal til et potensiometer. Dette er kun forskjellige metoder for å sende signaler til dronen.
Potensiometeret er som en (lysbryter med dimmer.)

# Materialer og Metode
For å få til et lavt massesenter, bestemte vi oss for å plassere batteriet lavest mulig.
...
![](bilder/Limt sammen kretsskort.jpg){width="60%"}

Vi overførte test-koden til mikrokontrollen via en USB kabel og testet kontrollen med recieveren koblet til en servo.
Etter det ble kretskortene limt fast til pleksiglasset, og kontrolleren ble til.
I tilleg ble alle komponentene loddet fast på kretskortet.

![nesten ferdig](bilder/Nesten ferdig kontroll.jpg){width="35%"} ![kabelsalat](bilder/Kabelsalat.jpg){width="65%"}


## Miniheisekran

Det ble satt sammen en enkel firkantet treramme uten bunn. I bunnen ble det skudd fast to små planker til å holde kranen oppe. Kraneen var kun inprovisering og ingen mål ble tatt. Om kranen er skjev, vil fortsatt motoren henge beint. I midten på toppen av rammen ble det drillet et hull og ved siden av hullet ble det limt fast en servo. En servo er en elektrisk motor med girkasse. Knyttet tråden fast i servoen og tredde den gjennom hullet. Knyttet motoren til andre enden av tråden. Ved å vri på servoen kan man stille høyden til motoren. Servoen trenger ikke å styres med strøm. Hensikten med servoen var at man kan vri på den uten at den spinner tilbake når den møter litt motstand
**Bilde kran**
![](bilder/Motor heis.jpg)
...
\newpage
Dronen er selvdesignet. Ved å legge metalrørene oppå hverandre i kryss istedenfor å for å ha 4 separate armer,
reduserer man antall deler og får en mer solid drone. For å unngå betydelig høydeforskjell på armene ble midten av hvert rør most flat med en tang.

![](bilder/torturert kosteskaft.jpg){width="80%"}

Når rørene var i riktig konfigurasjon, ble tek7 brukt rundt hullene for å feste armene til boksen.
Den orginale planen var å bruke muttere og bolter til å holde rørene sammen,
men etter at plastboken ble en del av struturen, var dronen solid nok til at det holdt med plastboksen og tek7 til å holde dronen sammen.
Ved å bruke en plastboks slik, kan bateriet være inne i boksen som den nederste delen.
Nå har dronen et lavt center av masse. På grunn av boksen, hadde vi en flate oppå lokket som gjor det enkelt å montere elektronikken.
...
## Festing av motorer
Designet hadde en utfordring. Motorenene er laget for å monteres på en flat overflate.
...
Det går et lite hull i spissen på motoren med ukjent hensikt. Siden motoren er symetrisk, skulle den i teorien henge i vater,
uansett hva man henger snoren i. Planen var å la det være en klump med tokomponent epoxy lim på hver av endene på armene til dronen.
Deretter heise motoren forsiktig ned til den såvidt treffer limen. Da kan man forsterke med mer lim etterpå. Dette ble løst ved å bygge en manuel mini heisekran.
Denne løsningen gikk ikke som planlagt. Tre tykke ledninger stakk ut fra motoren slik at den ikke hang beint. Det var ikke forutsatt.

Løsningen ble å plasere dronen på en vatret overflate.
...
\newpage
Her er den så godt som ferdige dronen:

![](bilder/ca-ferdig-drone.png)

# Diskusjon
![](bilder/kost.png){width="50%"}

Avgjørelsen for mariale ble tatt etter oliver en vakker dag kostet gulvet.
Han oppdaget at metallrøret som var igjen dersom man fjenet håndtak og børste veide svært lite og var sterkt.
Da ble det funnet ut at metallet er magnetisk og må derfor være en type stål.
Selv om plastik veier mindre, har det et lavere styrke til vekt forhold. Det vil si at man måtte brukt mer plastikk for å oppnå samme styrke.
Veggene i stålrøret er ekstremt tynne og veier derfor mindre enn et tilsvarennde plastrør.
Man kunne poteniselt brukt et annet design for å bygge en i plast som hadde veid mindre,
...
Til våres formål er det kun to joysticker og 4 kanaler vi trenger, men resten kan komme til nytte i et fremtidig prosjekt.

Siden eksoskjellettet til dronen tåler ekstreme temperaturer så godt,
kan det for eksempel brukes på olje-platformer og i arktiske strøk,
...
Å bygge en drone selv gir likevell nyttig kunskap og erfaring og
